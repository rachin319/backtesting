...
#=========================================
    ...
    varList = [ 'inited',
		...
		'dfr_2']
    #----------------------------------------------------------------------
    def __init__(self, ctaEngine, setting,fileName="testD"):
...
#2016/11/21=============================================================
		...
		if self.buyPrice[i] <= self.dfr and self.postoday[self.longsymbol]<(i+1)*self.longBuyUnit :
		    ...
		    #self.saveParameter()
		#print i, self.postoday[self.shortsymbol], self.shortBuyUnit
		    ...
		    self.postoday[self.shortsymbol] -= self.shortBuyUnit
		    #self.saveParameter()
		#print i, self.postoday[self.longsymbol], self.longBuyUnit
